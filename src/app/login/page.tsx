            ...
            <div className="w-full max-w-md space-y-8">
                ...
                <form className="mt-8 space-y-6">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <button
                            formAction={signup}
                            className="group relative flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 dark:bg-gray-700 dark:text-white dark:ring-gray-600 dark:hover:bg-gray-600"
                        >
                            Criar conta
                        </button>
                    </div>
